...
if __name__ == "__main__":
    print("\n--- Testing January ---")
    run_backtest("/home/ubuntu/sena3fx/data/ohlc/USDJPY_1m_2026_Jan.csv", spread_pips=0.4)
    print("\n--- Testing February ---")
    run_backtest("/home/ubuntu/sena3fx/data/ohlc/USDJPY_1m_2026_Feb.csv", spread_pips=0.4)
