...
from strategies.yagami_mtf_v7 import generate_signals
...
def main():
    ...
    results = engine.run(df, signal_func, name="Yagami_v7_Fixed")
    
    print("\n" + "=" * 80)
    print("【RUN-012v7-Fixed】ストレス・テスト結果")
    print("=" * 80)
