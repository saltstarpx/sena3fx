...
from strategies.yagami_mtf_v44 import generate_signals
...
def main():
    ...
    results = engine.run(df, signal_series, tp_series, sl_series, name="Yagami_v44_Fixed")
    
    print("\n" + "=" * 80)
    print("【RUN-012v44-Fixed】ストレス・テスト結果")
    print("=" * 80)
    ...
    if results['total_trades'] > 0:
        ...
        output_csv = os.path.join(BASE_DIR, 'results', 'run012v44_trades.csv')
