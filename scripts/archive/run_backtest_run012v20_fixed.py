...
from strategies.yagami_mtf_v20 import generate_signals, calculate_bb
...
def main():
    ...
    results = engine.run(df, signal_func, sl_series, name="Yagami_v20_Fixed")
    
    print("\n" + "=" * 80)
    print("【RUN-012v20-Fixed】ストレス・テスト結果")
    print("=" * 80)
