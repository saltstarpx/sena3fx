...
from strategies.yagami_mtf_v5 import generate_signals
...
def main():
    ...
    print("=" * 80)
    print("RUN-012v5: やがみ式3層MTF戦略 v5 - 高頻度・スプレッド耐性テスト")
    print("=" * 80)
    ...
    def signal_func(data):
        """シグナル関数"""
        # シグナルSeriesから現在の時刻に対応する値を取得
        # signal_seriesは1分足ごとのSeries
    ...
    results = engine.run(
        ...
        freq='1min',
        name="Yagami_v5_Stress_Test"
    )
    
    # 結果表示
    print("\n" + "=" * 80)
    print("【RUN-012v5】高頻度・スプレッド耐性テスト結果")
    print("=" * 80)
    ...
    if 'trades' in results and results['trades']:
        ...
        trades_path = os.path.join(BASE_DIR, 'results', 'run012v5_trades.csv')
