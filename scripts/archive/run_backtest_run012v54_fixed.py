...
from strategies.yagami_mtf_v54 import generate_signals
...
def run_backtest(csv_path, spread=0.01):
    ...
    pd.DataFrame(trades).to_csv("/home/ubuntu/sena3fx/results/run012v54_trades.csv", index=False)
