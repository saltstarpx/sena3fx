...
from strategies.yagami_mtf_v50 import generate_signals
...
def main():
    ...
    results = engine.run(df, signals, name="Yagami_v50_Optimized")
    
    print("\n" + "=" * 80)
    print("【RUN-012v50-Optimized】ストレス・テスト結果")
    print("=" * 80)
    ...
    if results['total_trades'] > 0:
        ...
        output_csv = os.path.join(BASE_DIR, 'results', 'run012v50_trades.csv')
