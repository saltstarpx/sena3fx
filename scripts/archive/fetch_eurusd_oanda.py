"""
OANDA APIからEURUSD OHLCデータを取得してCSVに保存する。
...
保存先: /home/ubuntu/sena3fx/data/
  eurusd_is_1m.csv  / eurusd_oos_1m.csv
  eurusd_is_15m.csv / eurusd_oos_15m.csv
  eurusd_is_4h.csv  / eurusd_oos_4h.csv
"""
import os
import sys
import time
...
TARGETS = [
    ("IS-1m",   "M1",  IS_START,  IS_END,   "eurusd_is_1m.csv"),
    ("IS-15m",  "M15", IS_START,  IS_END,   "eurusd_is_15m.csv"),
    ("IS-4h",   "H4",  IS_START,  IS_END,   "eurusd_is_4h.csv"),
    ("OOS-1m",  "M1",  OOS_START, OOS_END,  "eurusd_oos_1m.csv"),
    ("OOS-15m", "M15", OOS_START, OOS_END,  "eurusd_oos_15m.csv"),
    ("OOS-4h",  "H4",  OOS_START, OOS_END,  "eurusd_oos_4h.csv"),
]
...
def main():
    ...
    print("=" * 60)
    print("EURUSD OHLCデータ取得スクリプト（IS/OOS × 3時間軸）")
