...
plt.tight_layout()
out_path = os.path.join(OUT_DIR, "7sym_vmax_2026_result.png")
plt.savefig(out_path, dpi=150, bbox_inches="tight"); plt.close()
print(f"\nチャート保存: {out_path}")

accepted_df.to_csv(os.path.join(OUT_DIR, "7sym_vmax_2026_trades.csv"), index=False)
np.save(os.path.join(OUT_DIR, "7sym_vmax_2026_equity.npy"), eq_arr)
print("完了。")
