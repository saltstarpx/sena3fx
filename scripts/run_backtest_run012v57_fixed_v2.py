...
from strategies.yagami_mtf_v57 import generate_signals
...
def run_backtest(csv_path, spread_pips=1.0):
    ...
    print("="*80)
    print(f"【RUN-012v57-Corrected】結果")
    ...
    pd.DataFrame(trades).to_csv("/home/ubuntu/sena3fx/results/run012v57_corrected_trades.csv", index=False)

if __name__ == "__main__":
    # 1月と2月両方実行
    print("\n--- Testing January ---")
    run_backtest("/home/ubuntu/sena3fx/data/ohlc/USDJPY_1m_2026_Jan.csv")
    print("\n--- Testing February ---")
    run_backtest("/home/ubuntu/sena3fx/data/ohlc/USDJPY_1m_2026_Feb.csv")
