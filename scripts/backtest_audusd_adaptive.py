"""
backtest_audusd_adaptive.py
============================
AUDUSD 1銘柄集中バックテスト（アダプティブリスク 2〜3%）
FX銘柄 Goldロジック順位 第1位（OOS PF=1.98）の検証
...
def main():
    print("\n" + "="*80)
    print("  AUDUSD 集中戦略バックテスト（アダプティブリスク 2〜3%, 0.5%刻み）")
    print(f"  FX Goldロジック 第1位（OOS PF=1.98）")
