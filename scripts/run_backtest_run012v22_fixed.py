...
from strategies.yagami_mtf_v22 import generate_signals
...
def main():
    ...
    results = engine.run(df, signal_func, sl_series, name="Yagami_v22_Fixed")
    
    print("\n" + "=" * 80)
    print("【RUN-012v22-Fixed】ストレス・テスト結果")
    print("=" * 80)
