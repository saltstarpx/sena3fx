...
> **v80採用（2026/3/15）**: 指標予測力分析により、安定した予測力を持つフィルター（KMID r=+0.122 / 4Hボディ比率 r=+0.052）のみ残し、不安定フィルター（日足EMA/ADX/Streak/EMA距離）を除去。GBPUSD/EURUSD/USDCADの3銘柄で採用。NZDUSD/XAUUSD/AUDUSD/USDJPYは現行維持（v80でMDD悪化or OOS/IS過学習）。
...
- **ポートフォリオ平均**: PF 2.16→2.51(+16%)、Sharpe 4.26→5.83(+37%)
