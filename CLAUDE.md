...
| 銘柄 | 戦略 | PF | Sharpe | MDD | Kelly | tol_factor | 月+ |
|---|---|:---:|:---:|:---:|:---:|:---:|:---:|
| **USDJPY** | v77 Logic-C（オーパーツ） | 1.19 | 1.61 | 50.9% | 0.084 | 0.30 | 9/14 |
| **GBPUSD** | v79A Logic-A（GOLD） | 1.94 | 5.72 | 25.5% | 0.323 | 0.30 | 13/14 |
| **EURUSD** | v77 Logic-C（オーパーツ） | 1.79 | 6.13 | 22.7% | 0.279 | 0.30 | 13/14 |
| **USDCAD** | v79A Logic-A（GOLD） | 2.02 | 5.07 | 25.8% | 0.336 | 0.30 | 14/14 |
| **NZDUSD** | v79A Logic-A（GOLD）**tol=0.20** | **2.14** | **5.88** | **12.8%** | 0.368 | **0.20** | **14/14** |
| **XAUUSD** | v79A Logic-A（GOLD）**tol=0.20** | **2.46** | 3.87 | **12.6%** | 0.409 | **0.20** | 12/14 |
| **AUDUSD** | v79BC Logic-B（ADX+Streak） | 2.19 | 4.85 | 18.9% | 0.353 | 0.30 | 14/14 |
...
| FX | USDJPY/EURUSD | オーパーツ(v77) | 1.19/1.79 | 0.30 | Logic-C |
| FX | AUDUSD | ADX+Streak | 2.19 | 0.30 | Logic-B |
