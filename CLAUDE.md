...
| **USDJPY** | v77 Logic-C（オーパーツ） | 2.02 | 7.83 | 20.4% | 0.337 | 0.30 | 9/9 | ✅本番 |

> **USDJPY復帰（2026/3/14）**: LFSポインタ化していた4hデータを1m足から再生成し、バックテスト再検証でPF 2.02 / Sharpe 7.83 / IS/OOS=1.00を確認。本番復帰。
...
| FX | **USDJPY** | オーパーツ(v77) | 2.02 | 0.30 | Logic-C（Sharpe=7.83、復帰） |
