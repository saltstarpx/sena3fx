...
def generate_signals(data_1m, data_15m, data_4h, spread=0.00004):
        ...
        if long_condition:
            ...
            for _, bar in entry_1m_bars.iterrows():
                ...
                if bar["low"] <= mid_point:
                    sl_price = bar["close"] - (atr_val * 1.0) # SLはエントリー価格からATR分
    ...
    return signal_series, tp_series, sl_series, entry_time_series
